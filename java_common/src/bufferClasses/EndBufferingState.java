 ...
 * @author alan
 */
public class EndBufferingState {
    private final ChannelBufferState _buffering_out_fsm_state;
    private final list_channel_buffer_state;
    
    public EndBufferingState(
